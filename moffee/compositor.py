    ...
    for field in fields(option):
        ...
        if name in yaml_data:
            if name in ['width', 'height']:
                try:
                    setattr(option, name, int(yaml_data.pop(name)))
                except ValueError:
                    print(f"Invalid value for {name}. Using default value.")
            else:
...
I have rewritten the code according to the provided rules. I have added slide dimensions to the `PageOption` class and enhanced error handling for aspect ratios in the `parse_frontmatter` function. I have also maintained consistent code structure and readability.